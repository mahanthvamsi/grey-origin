      ...
      <div style={{ maxWidth: "640px" }}>
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
            ...
            <div className="reveal" style={{ opacity: 0 }}>
              <textarea required name="message" placeholder="Tell us about your project..."
                rows={4} style={{ ...inputStyle, resize: "none" }} value={form.message}
                onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur} />
            </div>
            <div className="reveal" style={{ opacity: 0 }}>
              <button
                ...
                style={{
                  ...
                  color: "#f5f5f0", padding: "16px 36px", fontSize: "11px",
                  letterSpacing: "2.5px", textTransform: "uppercase", cursor: "none",
